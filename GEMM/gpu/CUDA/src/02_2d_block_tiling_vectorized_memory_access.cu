    ...
    if (c_row_idx < m && c_col_idx < n) {
        ...
        while (K_block_tile_id < K_block_tile_num) {
            ...
            load_data_from_global_memory_to_shared_memory_vectorized
                <T, BLOCK_TILE_SIZE_M, BLOCK_TILE_SIZE_N, BLOCK_TILE_SIZE_K, NUM_THREADS, int4>(
                                       ...
                                       T* C, size_t ldc, cudaStream_t stream)
{
    ...
    dim3 const grid_dim{
        ...
        gemm_v02_vectorized<T, BLOCK_TILE_SIZE_M, BLOCK_TILE_SIZE_N, BLOCK_TILE_SIZE_K, NUM_THREADS>
