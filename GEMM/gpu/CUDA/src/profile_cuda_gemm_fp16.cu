...
int main()
{
    ...
    std::vector<std::pair<
        ...
        gemm_fp16_kernel_launch_functions{
            ...
            // {"Custom GEMM Kernel V05 Vectorized", launch_gemm_kernel_v05_vectorized<__half>},
            // {"Custom GEMM Kernel V06", launch_gemm_kernel_v06<__half>},
            // {"Custom GEMM Kernel V06 Vectorized", launch_gemm_kernel_v06_vectorized<__half>},
            // {"Custom GEMM Kernel V06 Vectorized Double Buffered", launch_gemm_kernel_v06_vectorized_double_buffered<__half>},
        };
    ...
    std::vector<std::pair<
        ...
        gemm_fp16_tensor_core_kernel_launch_functions{
            ...
            // {"Custom GEMM Kernel V07 Vectorized", launch_gemm_kernel_v07_vectorized<__half>},
            {"Custom GEMM Kernel V07 Vectorized Double Buffered", launch_gemm_kernel_v07_vectorized_double_buffered<__half>},
        };
